...
#[cfg(coex)]
use crate::radio::{hal::ram, sys::c_types::c_void};

#[cfg(all(coex, any(esp32, esp32c2, esp32c3, esp32c6, esp32s3)))]
pub(super) static mut G_COEX_ADAPTER_FUNCS: crate::radio::sys::include::coex_adapter_funcs_t =
    crate::radio::sys::include::coex_adapter_funcs_t {
        _version: crate::radio::sys::include::COEX_ADAPTER_VERSION as i32,
        ...
        _magic: crate::radio::sys::include::COEX_ADAPTER_MAGIC as i32,
...
unsafe extern "C" fn esp_coexist_debug_matrix_init_wrapper(
    ...
    crate::radio::sys::include::ESP_ERR_NOT_SUPPORTED as i32
}
