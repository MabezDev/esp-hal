...
use crate::ram;
#[cfg(coex)]
use super::super::sys::c_types::c_void;

#[cfg(all(coex, any(esp32, esp32c2, esp32c3, esp32c6, esp32s3)))]
pub(super) static mut G_COEX_ADAPTER_FUNCS: super::super::sys::include::coex_adapter_funcs_t =
    super::super::sys::include::coex_adapter_funcs_t {
        _version: super::super::sys::include::COEX_ADAPTER_VERSION as i32,
        ...
        _magic: super::super::sys::include::COEX_ADAPTER_MAGIC as i32,
...
unsafe extern "C" fn xtal_freq_get_wrapper() -> i32 {
    crate::clock::Clocks::get().xtal_clock.as_mhz() as i32
}
...
unsafe extern "C" fn esp_coexist_debug_matrix_init_wrapper(
    ...
    super::super::sys::include::ESP_ERR_NOT_SUPPORTED as i32
}

#[cfg(coex)]
#[ram]
unsafe extern "C" fn semphr_take_from_isr_wrapper(semphr: *mut c_void, hptw: *mut c_void) -> i32 {
    unsafe { super::super::common_adapter::semphr_take_from_isr(semphr, hptw as *mut bool) }
}

#[cfg(coex)]
#[ram]
unsafe extern "C" fn semphr_give_from_isr_wrapper(semphr: *mut c_void, hptw: *mut c_void) -> i32 {
    unsafe { super::super::common_adapter::semphr_give_from_isr(semphr, hptw as *mut bool) }
}

#[cfg(coex)]
unsafe extern "C" fn is_in_isr_wrapper() -> i32 {
    super::super::is_interrupts_disabled() as i32
}
