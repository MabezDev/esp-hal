...
const MTU: usize = esp_config_int!(usize, "ESP_HAL_CONFIG_WIFI_MTU");
...
impl WifiError {
    fn from_error_code(code: i32) -> Self {
        if crate::radio::sys::include::ESP_FAIL == code {
            return WifiError::Failed;
        }

        match code as u32 {
            crate::radio::sys::include::ESP_ERR_NO_MEM => WifiError::OutOfMemory,
            crate::radio::sys::include::ESP_ERR_INVALID_ARG => WifiError::InvalidArguments,
            crate::radio::sys::include::ESP_ERR_WIFI_NOT_INIT => WifiError::NotInitialized,
            crate::radio::sys::include::ESP_ERR_WIFI_NOT_STARTED => WifiError::NotStarted,
            crate::radio::sys::include::ESP_ERR_WIFI_NOT_STOPPED => WifiError::NotStopped,
            crate::radio::sys::include::ESP_ERR_WIFI_IF => WifiError::Interface,
            crate::radio::sys::include::ESP_ERR_WIFI_MODE => WifiError::Mode,
            crate::radio::sys::include::ESP_ERR_WIFI_STATE => WifiError::State,
            crate::radio::sys::include::ESP_ERR_WIFI_CONN => WifiError::ControlBlock,
            crate::radio::sys::include::ESP_ERR_WIFI_NVS => WifiError::Nvs,
            crate::radio::sys::include::ESP_ERR_WIFI_MAC => WifiError::InvalidMac,
            crate::radio::sys::include::ESP_ERR_WIFI_SSID => WifiError::InvalidSsid,
            crate::radio::sys::include::ESP_ERR_WIFI_PASSWORD => WifiError::InvalidPassword,
            crate::radio::sys::include::ESP_ERR_WIFI_TIMEOUT => WifiError::Timeout,
            crate::radio::sys::include::ESP_ERR_WIFI_WAKE_FAIL => WifiError::WakeFailed,
            crate::radio::sys::include::ESP_ERR_WIFI_WOULD_BLOCK => WifiError::WouldBlock,
            crate::radio::sys::include::ESP_ERR_WIFI_NOT_CONNECT => WifiError::NotConnected,
            crate::radio::sys::include::ESP_ERR_WIFI_POST => WifiError::PostFail,
            crate::radio::sys::include::ESP_ERR_WIFI_INIT_STATE => WifiError::InvalidInitState,
            crate::radio::sys::include::ESP_ERR_WIFI_STOP_STATE => WifiError::StopState,
            crate::radio::sys::include::ESP_ERR_WIFI_NOT_ASSOC => WifiError::NotAssociated,
            crate::radio::sys::include::ESP_ERR_WIFI_TX_DISALLOW => WifiError::TxDisallowed,
...
pub(crate) fn coex_initialize() -> i32 {
    ...
    unsafe {
        let res = crate::radio::sys::include::esp_coex_adapter_register(
        ...
        let res = crate::radio::sys::include::coex_pre_init();
        if res != 0 {
...
pub(crate) unsafe extern "C" fn coex_init() -> i32 {
    #[cfg(coex)]
    {
        ...
        return unsafe { crate::radio::sys::include::coex_init() };
    }
...
fn wifi_deinit() -> Result<(), crate::radio::wifi::WifiError> {
...
pub(crate) fn apply_power_saving(ps: PowerSaveMode) -> Result<(), WifiError> {
    esp_wifi_result!(unsafe {
        crate::radio::sys::include::esp_wifi_set_ps(match ps {
            PowerSaveMode::None => crate::radio::sys::include::wifi_ps_type_t_WIFI_PS_NONE,
            PowerSaveMode::Minimum => crate::radio::sys::include::wifi_ps_type_t_WIFI_PS_MIN_MODEM,
            PowerSaveMode::Maximum => crate::radio::sys::include::wifi_ps_type_t_WIFI_PS_MAX_MODEM,
        })
    })?;
    Ok(())
}
...
pub fn new<'d>(
    ...
    if crate::radio::is_interrupts_disabled() {
    ...
    unsafe {
        internal::G_CONFIG = wifi_init_config_t {
            ...
            beacon_max_len: crate::radio::sys::include::WIFI_SOFTAP_BEACON_MAX_LEN as i32,
...
impl WifiController<'_> {
    ...
    pub fn is_connected(&self) -> Result<bool, WifiError> {
        match station_state() {
            ...
            WifiStationState::Disconnected => Err(WifiError::Disconnected),
