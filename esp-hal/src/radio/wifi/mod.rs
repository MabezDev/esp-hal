...
use crate::ram;
use self::event::{EventInfo, WifiEvent};
pub mod ap;
...
/// Helper macro to wrap Wi-Fi driver function calls and convert error codes
#[doc(hidden)]
#[macro_export]
macro_rules! esp_wifi_result {
    ($value:expr) => {{
        ...
        let result = $value;
        if result != $crate::radio::sys::include::ESP_OK as i32 {
...
const MTU: usize = esp_config_int!(usize, "ESP_HAL_CONFIG_RADIO_WIFI_MTU");
...
impl WifiError {
    fn from_error_code(code: i32) -> Self {
        if super::sys::include::ESP_FAIL == code {
            return WifiError::Failed;
        }

        match code as u32 {
            super::sys::include::ESP_ERR_NO_MEM => WifiError::OutOfMemory,
            super::sys::include::ESP_ERR_INVALID_ARG => WifiError::InvalidArguments,
            super::sys::include::ESP_ERR_WIFI_NOT_INIT => WifiError::NotInitialized,
            super::sys::include::ESP_ERR_WIFI_NOT_STARTED => WifiError::NotStarted,
            super::sys::include::ESP_ERR_WIFI_NOT_STOPPED => WifiError::NotStopped,
            super::sys::include::ESP_ERR_WIFI_IF => WifiError::Interface,
            super::sys::include::ESP_ERR_WIFI_MODE => WifiError::Mode,
            super::sys::include::ESP_ERR_WIFI_STATE => WifiError::State,
            super::sys::include::ESP_ERR_WIFI_CONN => WifiError::ControlBlock,
            super::sys::include::ESP_ERR_WIFI_NVS => WifiError::Nvs,
            super::sys::include::ESP_ERR_WIFI_MAC => WifiError::InvalidMac,
            super::sys::include::ESP_ERR_WIFI_SSID => WifiError::InvalidSsid,
            super::sys::include::ESP_ERR_WIFI_PASSWORD => WifiError::InvalidPassword,
            super::sys::include::ESP_ERR_WIFI_TIMEOUT => WifiError::Timeout,
            super::sys::include::ESP_ERR_WIFI_WAKE_FAIL => WifiError::WakeFailed,
            super::sys::include::ESP_ERR_WIFI_WOULD_BLOCK => WifiError::WouldBlock,
            super::sys::include::ESP_ERR_WIFI_NOT_CONNECT => WifiError::NotConnected,
            super::sys::include::ESP_ERR_WIFI_POST => WifiError::PostFail,
            super::sys::include::ESP_ERR_WIFI_INIT_STATE => WifiError::InvalidInitState,
            super::sys::include::ESP_ERR_WIFI_STOP_STATE => WifiError::StopState,
            super::sys::include::ESP_ERR_WIFI_NOT_ASSOC => WifiError::NotAssociated,
            super::sys::include::ESP_ERR_WIFI_TX_DISALLOW => WifiError::TxDisallowed,
...
#[cfg(esp32)]
fn set_mac_time_update_cb(wifi: crate::peripherals::WIFI<'_>) {
...
pub(crate) fn wifi_init(_wifi: crate::peripherals::WIFI<'_>) -> Result<(), WifiError> {
    #[cfg(esp32)]
...
pub(crate) fn coex_initialize() -> i32 {
    ...
    unsafe {
        let res = super::sys::include::esp_coex_adapter_register(
        ...
        let res = super::sys::include::coex_pre_init();
        if res != 0 {
...
pub(crate) unsafe extern "C" fn coex_init() -> i32 {
    #[cfg(coex)]
    {
        ...
        return unsafe { super::sys::include::coex_init() };
    }
...
fn wifi_deinit() -> Result<(), super::WifiError> {
...
pub(crate) mod embassy {
    ...
    impl Driver for Interface<'_> {
        ...
        fn capabilities(&self) -> Capabilities {
            ...
            caps.max_burst_size =
                if esp_config_int!(usize, "ESP_HAL_CONFIG_RADIO_WIFI_MAX_BURST_SIZE") == 0 {
                    None
                } else {
                    Some(esp_config_int!(
                        usize,
                        "ESP_HAL_CONFIG_RADIO_WIFI_MAX_BURST_SIZE"
                    ))
                };
            caps
        }
...
pub(crate) fn apply_power_saving(ps: PowerSaveMode) -> Result<(), WifiError> {
    esp_wifi_result!(unsafe {
        super::sys::include::esp_wifi_set_ps(match ps {
...
/// ```
pub fn new<'d>(
    device: crate::peripherals::WIFI<'d>,
    ...
    if super::is_interrupts_disabled() {
    ...
    unsafe {
        internal::G_CONFIG = wifi_init_config_t {
            ...
            tx_buf_type: super::sys::include::CONFIG_ESP_WIFI_TX_BUFFER_TYPE as i32,
            static_tx_buf_num: config.static_tx_buf_num as _,
            dynamic_tx_buf_num: config.dynamic_tx_buf_num as _,
            rx_mgmt_buf_type: super::sys::include::CONFIG_ESP_WIFI_DYNAMIC_RX_MGMT_BUF as i32,
            rx_mgmt_buf_num: super::sys::include::CONFIG_ESP_WIFI_RX_MGMT_BUF_NUM_DEF as i32,
            cache_tx_buf_num: super::sys::include::WIFI_CACHE_TX_BUFFER_NUM as i32,
            ...
            beacon_max_len: super::sys::include::WIFI_SOFTAP_BEACON_MAX_LEN as i32,
            mgmt_sbuf_num: super::sys::include::WIFI_MGMT_SBUF_NUM as i32,
            feature_caps: internal::__ESP_RADIO_G_WIFI_FEATURE_CAPS,
            sta_disconnected_pm: false,
            espnow_max_encrypt_num: super::sys::include::CONFIG_ESP_WIFI_ESPNOW_MAX_ENCRYPT_NUM
                as i32,
    ...
    unsafe { crate::rng::TrngSource::increase_entropy_source_counter() };
    ...
    Ok((
        ...
        Interfaces {
            ...
            #[cfg(all(feature = "esp-now", feature = "unstable"))]
            esp_now: crate::radio::esp_now::EspNow::new_internal(),
            #[cfg(all(feature = "sniffer", feature = "unstable"))]
            sniffer: Sniffer::new(),
        },
    ))
...
impl Drop for WifiController<'_> {
    fn drop(&mut self) {
        state::locked(|| {
            ...
            crate::rng::TrngSource::decrease_entropy_source_counter(unsafe {
                crate::Internal::conjure()
            });
        })
    }
}
...
impl WifiController<'_> {
    ...
    pub fn set_csi(
        ...
        cb: impl FnMut(csi::WifiCsiInfo<'_>) + Send,
    ) -> Result<(), WifiError> {
        csi.apply_config()?;
    ...
    pub fn is_connected(&self) -> Result<bool, WifiError> {
        match station_state() {
            WifiStationState::Connected => Ok(true),
            WifiStationState::Disconnected => {
