...
pub(crate) unsafe extern "C" fn regdma_link_set_write_wait_content_dummy(
    _arg1: *mut crate::radio::sys::c_types::c_void,
    _arg2: u32,
    _arg3: u32,
) {
    todo!()
...
pub(crate) unsafe extern "C" fn sleep_retention_find_link_by_id_dummy(
    _arg1: crate::radio::sys::c_types::c_int,
) -> *mut crate::radio::sys::c_types::c_void {
    todo!()
}

pub(crate) unsafe extern "C" fn sleep_retention_entries_create_dummy(
    _arg1: *const crate::radio::sys::c_types::c_void,
    _arg2: crate::radio::sys::c_types::c_int,
    _arg3: crate::radio::sys::c_types::c_int,
    _arg4: crate::radio::sys::c_types::c_int,
...
pub unsafe extern "C" fn set_isr(
    n: i32,
    f: *mut crate::radio::sys::c_types::c_void,
    arg: *mut crate::radio::sys::c_types::c_void,
) {
    trace!("set_isr - interrupt {} function {:?} arg {:?}", n, f, arg);

    match n {
        0 => unsafe {
            crate::radio::wifi::ISR_INTERRUPT_1 = (f, arg);
        },
        1 => unsafe {
            crate::radio::wifi::ISR_INTERRUPT_1 = (f, arg);
        },
