...
use super::super::phy::PhyController;
...
use crate::clock::ModemClockController;
use crate::peripherals::WIFI;
use super::super::memory_fence::memory_fence;
use super::super::sys::c_types::*;
use super::super::time::{blob_ticks_to_micros, millis_to_blob_ticks};
...
pub unsafe extern "C" fn set_intr(cpu_no: i32, intr_source: u32, intr_num: u32, intr_prio: i32) {
    ...
    unsafe {
        os_adapter_chip_specific::set_intr(
            cpu_no,
            intr_source,
            intr_num,
            intr_prio,
...
pub unsafe extern "C" fn spin_lock_create() -> *mut c_void {
    let ptr = super::super::compat::semaphore::sem_create(1, 1);
...
pub unsafe extern "C" fn spin_lock_delete(lock: *mut c_void) {
    ...
    super::super::compat::semaphore::sem_delete(lock);
}
...
pub unsafe extern "C" fn task_yield_from_isr() {
    ...
    super::super::preempt::yield_task_from_isr();
}
...
pub unsafe extern "C" fn mutex_create() -> *mut c_void {
    trace!("mutex_create");
    super::super::compat::mutex::mutex_create(false)
}
...
pub unsafe extern "C" fn recursive_mutex_create() -> *mut c_void {
    ...
    super::super::compat::mutex::mutex_create(true)
}
...
pub unsafe extern "C" fn mutex_delete(mutex: *mut c_void) {
    super::super::compat::mutex::mutex_delete(mutex);
}
...
pub unsafe extern "C" fn mutex_lock(mutex: *mut c_void) -> i32 {
    super::super::compat::mutex::mutex_lock(mutex)
}
...
pub unsafe extern "C" fn mutex_unlock(mutex: *mut c_void) -> i32 {
    super::super::compat::mutex::mutex_unlock(mutex)
}
...
fn common_task_create(
    ...
    unsafe {
        let task_func = core::mem::transmute::<
            *mut c_void,
            extern "C" fn(*mut super::super::sys::c_types::c_void),
        >(task_func);

        let task = super::super::preempt::task_create(
            task_name,
            task_func,
            param,
            prio,
...
pub unsafe extern "C" fn task_delete(task_handle: *mut c_void) {
    ...
    unsafe {
        super::super::preempt::schedule_task_deletion(NonNull::new(task_handle.cast::<()>()));
    }
}
...
pub unsafe extern "C" fn task_delay(tick: u32) {
    ...
    super::super::preempt::usleep(blob_ticks_to_micros(tick))
}
...
pub unsafe extern "C" fn task_get_current_task() -> *mut c_void {
    let res = super::super::preempt::current_task().cast::<c_void>().as_ptr();
...
pub unsafe extern "C" fn task_get_max_priority() -> i32 {
    ...
    super::super::preempt::max_task_priority() as i32
}
...
pub unsafe extern "C" fn malloc(size: usize) -> *mut c_void {
    unsafe { super::super::compat::malloc::malloc(size).cast() }
}
...
pub unsafe extern "C" fn free(p: *mut c_void) {
    unsafe {
        super::super::compat::malloc::free(p.cast());
    }
}
...
pub unsafe extern "C" fn event_post(
    ...
    match event {
        WifiEvent::StationConnected | WifiEvent::StationDisconnected => {
            super::embassy::STA_LINK_STATE_WAKER.wake();
        }

        WifiEvent::AccessPointStart | WifiEvent::AccessPointStop => {
            super::embassy::AP_LINK_STATE_WAKER.wake();
        }
...
pub unsafe extern "C" fn get_free_heap_size() -> u32 {
    unsafe { super::super::compat::malloc::get_free_internal_heap_size() as u32 }
}
...
pub unsafe extern "C" fn rand() -> u32 {
    unsafe { super::super::common_adapter::random() }
}
...
pub unsafe extern "C" fn get_random(buf: *mut u8, len: usize) -> c_int {
    trace!("get_random");
    unsafe {
        super::super::common_adapter::__esp_radio_esp_fill_random(buf, len as u32);
    }
    0
}
...
pub unsafe extern "C" fn log_write(
    ...
    unsafe {
        super::super::sys::log::syslog(level, format as _, args);
    }
}
...
pub unsafe extern "C" fn log_writev(
    ...
    _tag: *const c_char,
    format: *const c_char,
    args: super::super::sys::include::va_list,
) {
    unsafe {
        super::super::sys::log::syslog(
            level,
            format as _,
            core::mem::transmute::<super::super::sys::include::va_list, core::ffi::VaListImpl<'_>>(args),
        );
    }
}
...
pub unsafe extern "C" fn malloc_internal(size: usize) -> *mut c_void {
    unsafe { super::super::compat::malloc::malloc_internal(size).cast() }
}
...
pub unsafe extern "C" fn realloc_internal(ptr: *mut c_void, size: usize) -> *mut c_void {
    unsafe { super::super::compat::malloc::realloc_internal(ptr.cast(), size).cast() }
}
...
pub unsafe extern "C" fn wifi_create_queue(queue_len: c_int, item_size: c_int) -> *mut c_void {
    let queue = super::super::compat::queue::queue_create(queue_len, item_size);
...
pub unsafe extern "C" fn wifi_delete_queue(queue: *mut c_void) {
    ...
    super::super::compat::queue::queue_delete(*boxed)
}
...
pub unsafe extern "C" fn coex_deinit() {
    ...
    #[cfg(coex)]
    unsafe {
        super::super::sys::include::coex_deinit()
    };
}
...
pub unsafe extern "C" fn coex_enable() -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_enable() };
...
pub unsafe extern "C" fn coex_disable() {
    ...
    #[cfg(coex)]
    unsafe {
        super::super::sys::include::coex_disable()
    };
}
...
pub unsafe extern "C" fn coex_status_get() -> u32 {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_status_get(0b1) }; // COEX_STATUS_GET_WIFI_BITMAP
...
pub unsafe extern "C" fn coex_wifi_request(event: u32, latency: u32, duration: u32) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_wifi_request(event, latency, duration) };
...
pub unsafe extern "C" fn coex_wifi_release(event: u32) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_wifi_release(event) };
...
pub unsafe extern "C" fn coex_wifi_channel_set(primary: u8, secondary: u8) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_wifi_channel_set(primary, secondary) };
...
pub unsafe extern "C" fn coex_event_duration_get(event: u32, duration: *mut u32) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_event_duration_get(event, duration) };
...
pub unsafe extern "C" fn coex_pti_get(event: u32, pti: *mut u8) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_pti_get(event, pti) };
...
pub unsafe extern "C" fn coex_schm_status_bit_clear(type_: u32, status: u32) {
    ...
    #[cfg(coex)]
    unsafe {
        super::super::sys::include::coex_schm_status_bit_clear(type_, status)
    };
}
...
pub unsafe extern "C" fn coex_schm_status_bit_set(type_: u32, status: u32) {
    ...
    #[cfg(coex)]
    unsafe {
        super::super::sys::include::coex_schm_status_bit_set(type_, status)
    };
}
...
pub unsafe extern "C" fn coex_schm_interval_set(interval: u32) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_schm_interval_set(interval) };
...
pub unsafe extern "C" fn coex_schm_interval_get() -> u32 {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_schm_interval_get() };
...
pub unsafe extern "C" fn coex_schm_curr_period_get() -> u8 {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_schm_curr_period_get() };
...
pub unsafe extern "C" fn coex_schm_curr_phase_get() -> *mut c_void {
    ...
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_schm_curr_phase_get() };

    #[cfg(not(coex))]
    return core::ptr::null_mut();
}

pub unsafe extern "C" fn coex_schm_process_restart_wrapper() -> super::super::sys::c_types::c_int {
    ...
    #[cfg(coex)]
    unsafe {
        super::super::sys::include::coex_schm_process_restart()
    }
}

#[allow(unused_variables)]
pub unsafe extern "C" fn coex_schm_register_cb_wrapper(
    arg1: super::super::sys::c_types::c_int,
    cb: ::core::option::Option<
        unsafe extern "C" fn(arg1: super::super::sys::c_types::c_int) -> super::super::sys::c_types::c_int,
    >,
) -> super::super::sys::c_types::c_int {
    ...
    #[cfg(coex)]
    unsafe {
        super::super::sys::include::coex_schm_register_callback(
            arg1 as u32,
            unwrap!(cb) as *const super::super::sys::c_types::c_void as *mut super::super::sys::c_types::c_void,
        )
    }
}
...
pub unsafe extern "C" fn coex_register_start_cb(
    _cb: Option<unsafe extern "C" fn() -> super::super::sys::c_types::c_int>,
) -> super::super::sys::c_types::c_int {
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_register_start_cb(_cb) };
...
pub unsafe extern "C" fn coex_schm_get_phase_by_idx(
    _phase_idx: i32,
) -> *mut super::super::sys::c_types::c_void {
    #[cfg(coex)]
    return unsafe { super::super::sys::include::coex_schm_get_phase_by_idx(_phase_idx) };
