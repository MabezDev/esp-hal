...
pub unsafe extern "C" fn set_intr(cpu_no: i32, intr_source: u32, intr_num: u32, intr_prio: i32) {
    ...
    unsafe {
        crate::radio::wifi::os_adapter::os_adapter_chip_specific::set_intr(
            cpu_no,
            intr_source,
            intr_num,
            intr_prio,
...
pub unsafe extern "C" fn ints_on(mask: u32) {
    ...
    crate::radio::wifi::os_adapter::os_adapter_chip_specific::chip_ints_on(mask);
}
...
pub unsafe extern "C" fn ints_off(mask: u32) {
    ...
    crate::radio::wifi::os_adapter::os_adapter_chip_specific::chip_ints_off(mask);
}
...
pub unsafe extern "C" fn spin_lock_create() -> *mut c_void {
    let ptr = crate::radio::compat::semaphore::sem_create(1, 1);
...
pub unsafe extern "C" fn spin_lock_delete(lock: *mut c_void) {
    ...
    crate::radio::compat::semaphore::sem_delete(lock);
}
...
pub unsafe extern "C" fn mutex_create() -> *mut c_void {
    trace!("mutex_create");
    crate::radio::compat::mutex::mutex_create(false)
}
...
pub unsafe extern "C" fn recursive_mutex_create() -> *mut c_void {
    ...
    crate::radio::compat::mutex::mutex_create(true)
}
...
pub unsafe extern "C" fn mutex_delete(mutex: *mut c_void) {
    crate::radio::compat::mutex::mutex_delete(mutex);
}
...
pub unsafe extern "C" fn mutex_lock(mutex: *mut c_void) -> i32 {
    crate::radio::compat::mutex::mutex_lock(mutex)
}
...
pub unsafe extern "C" fn mutex_unlock(mutex: *mut c_void) -> i32 {
    crate::radio::compat::mutex::mutex_unlock(mutex)
}
...
fn common_task_create(
    ...
    unsafe {
        let task_func = core::mem::transmute::<
            *mut c_void,
            extern "C" fn(*mut crate::radio::sys::c_types::c_void),
        >(task_func);
...
pub unsafe extern "C" fn malloc(size: usize) -> *mut c_void {
    unsafe { crate::radio::compat::malloc::malloc(size).cast() }
}
...
pub unsafe extern "C" fn free(p: *mut c_void) {
    unsafe {
        crate::radio::compat::malloc::free(p.cast());
    }
}
...
pub unsafe extern "C" fn event_post(
    ...
    match event {
        WifiEvent::StationConnected | WifiEvent::StationDisconnected => {
            crate::radio::wifi::embassy::STA_LINK_STATE_WAKER.wake();
        }

        WifiEvent::AccessPointStart | WifiEvent::AccessPointStop => {
            crate::radio::wifi::embassy::AP_LINK_STATE_WAKER.wake();
        }
...
pub unsafe extern "C" fn get_free_heap_size() -> u32 {
    unsafe { crate::radio::compat::malloc::get_free_internal_heap_size() as u32 }
}
...
pub unsafe extern "C" fn rand() -> u32 {
    unsafe { crate::radio::common_adapter::random() }
}
...
pub unsafe extern "C" fn get_random(buf: *mut u8, len: usize) -> c_int {
    trace!("get_random");
    unsafe {
        crate::radio::common_adapter::__esp_radio_esp_fill_random(buf, len as u32);
    }
    0
}
...
pub unsafe extern "C" fn log_write(
    ...
    unsafe {
        crate::radio::sys::log::syslog(level, format as _, args);
    }
}
...
pub unsafe extern "C" fn log_writev(
    ...
    _tag: *const c_char,
    format: *const c_char,
    args: crate::radio::sys::include::va_list,
) {
    unsafe {
...
pub unsafe extern "C" fn malloc_internal(size: usize) -> *mut c_void {
    unsafe { crate::radio::compat::malloc::malloc_internal(size).cast() }
}
...
pub unsafe extern "C" fn realloc_internal(ptr: *mut c_void, size: usize) -> *mut c_void {
    unsafe { crate::radio::compat::malloc::realloc_internal(ptr.cast(), size).cast() }
}
...
pub unsafe extern "C" fn wifi_create_queue(queue_len: c_int, item_size: c_int) -> *mut c_void {
    let queue = crate::radio::compat::queue::queue_create(queue_len, item_size);
...
pub unsafe extern "C" fn wifi_delete_queue(queue: *mut c_void) {
    ...
    crate::radio::compat::queue::queue_delete(*boxed)
}
...
pub unsafe extern "C" fn coex_deinit() {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_deinit()
    };
}
...
pub unsafe extern "C" fn coex_enable() -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_enable() };
...
pub unsafe extern "C" fn coex_disable() {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_disable()
    };
}
...
pub unsafe extern "C" fn coex_status_get() -> u32 {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_status_get(0b1) }; // COEX_STATUS_GET_WIFI_BITMAP
...
pub unsafe extern "C" fn coex_wifi_request(event: u32, latency: u32, duration: u32) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_wifi_request(event, latency, duration) };
...
pub unsafe extern "C" fn coex_wifi_release(event: u32) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_wifi_release(event) };
...
pub unsafe extern "C" fn coex_wifi_channel_set(primary: u8, secondary: u8) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_wifi_channel_set(primary, secondary) };
...
pub unsafe extern "C" fn coex_event_duration_get(event: u32, duration: *mut u32) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_event_duration_get(event, duration) };
...
pub unsafe extern "C" fn coex_pti_get(event: u32, pti: *mut u8) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_pti_get(event, pti) };
...
pub unsafe extern "C" fn coex_schm_status_bit_clear(type_: u32, status: u32) {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_schm_status_bit_clear(type_, status)
    };
}
...
pub unsafe extern "C" fn coex_schm_status_bit_set(type_: u32, status: u32) {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_schm_status_bit_set(type_, status)
    };
}
...
pub unsafe extern "C" fn coex_schm_interval_set(interval: u32) -> c_int {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_schm_interval_set(interval) };
...
pub unsafe extern "C" fn coex_schm_interval_get() -> u32 {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_schm_interval_get() };
...
pub unsafe extern "C" fn coex_schm_curr_period_get() -> u8 {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_schm_curr_period_get() };
...
pub unsafe extern "C" fn coex_schm_curr_phase_get() -> *mut c_void {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_schm_curr_phase_get() };

    #[cfg(not(coex))]
    return core::ptr::null_mut();
}

pub unsafe extern "C" fn coex_schm_process_restart_wrapper() -> crate::radio::sys::c_types::c_int {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_schm_process_restart()
    }
}
...
pub unsafe extern "C" fn coex_register_start_cb(
    _cb: Option<unsafe extern "C" fn() -> crate::radio::sys::c_types::c_int>,
) -> crate::radio::sys::c_types::c_int {
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_register_start_cb(_cb) };
...
pub unsafe extern "C" fn coex_schm_get_phase_by_idx(
    _phase_idx: i32,
) -> *mut crate::radio::sys::c_types::c_void {
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_schm_get_phase_by_idx(_phase_idx) };
