...
pub(crate) fn chip_ints_on(mask: u32) {
    unsafe { crate::xtensa_lx::interrupt::enable_mask(mask) };
}

pub(crate) fn chip_ints_off(mask: u32) {
    crate::xtensa_lx::interrupt::disable_mask(mask);
}

pub(crate) unsafe extern "C" fn phy_common_clock_disable() {
    unsafe {
        super::super::super::common_adapter::phy_disable_clock();
    }
}

pub(crate) unsafe extern "C" fn phy_common_clock_enable() {
    unsafe {
        super::super::super::common_adapter::phy_enable_clock();
    }
}
