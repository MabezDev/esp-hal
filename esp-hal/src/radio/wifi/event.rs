...
pub(crate) mod sealed {
    ...
    pub trait Event {
        ...
        unsafe fn from_raw_event_data(ptr: *mut crate::radio::sys::c_types::c_void) -> Self;
    }
}
...
macro_rules! impl_wifi_event {
    ...
    ($newtype:ident) => {
        ...
        impl sealed::Event for $newtype {
            unsafe fn from_raw_event_data(_: *mut crate::radio::sys::c_types::c_void) -> Self {
                Self
            }
            fn handler() -> &'static NonReentrantMutex<Option<Box<Handler<Self>>>> {
    ...
    ($newtype:ident, $data:ident) => {
        use crate::radio::sys::include::$data;
        /// See [`WifiEvent`].
        #[derive(Copy, Clone)]
...
pub(crate) unsafe fn handle_raw<Event: EventExt>(
    event_data: *mut crate::radio::sys::c_types::c_void,
