...
pub(crate) static EVENT_CHANNEL: embassy_sync::pubsub::PubSubChannel<
    esp_sync::RawMutex,
    EventInfo,
    { esp_config_int!(usize, "ESP_HAL_CONFIG_RADIO_EVENT_CHANNEL_CAPACITY") },
    { esp_config_int!(usize, "ESP_HAL_CONFIG_RADIO_EVENT_CHANNEL_SUBSCRIBERS") },
    1,
...
trait Event {
    ...
    unsafe fn from_raw_event_data(ptr: *mut super::super::sys::c_types::c_void) -> Self;
}
...
macro_rules! impl_wifi_event {
    ...
    ($newtype:ident) => {
        ...
        impl Event for $newtype {
            unsafe fn from_raw_event_data(_: *mut super::super::sys::c_types::c_void) -> Self {
                Self
            }
        }
    };
    ...
    ($newtype:ident, $data:ident) => {
        use super::super::sys::include::$data;
        /// See [`WifiEvent`].
        #[derive(Copy, Clone)]
...
impl EventInfo {
    pub(crate) fn from_wifi_event_raw(
        event: WifiEvent,
        payload: *mut super::super::sys::c_types::c_void,
    ) -> Option<Self> {
...
/// - [WifiEvent::ScanDone]
///
/// [super::new] always enables these events, even if they were disabled beforehand.
#[instability::unstable]
