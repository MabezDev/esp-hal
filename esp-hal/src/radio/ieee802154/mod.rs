...
use crate::{clock::PhyClockGuard, peripherals::IEEE802154};
use super::phy::PhyInitGuard;
...
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub struct Config {
    /// Enable automatic ACK transmission.
    pub auto_ack_tx: bool,
    /// Enable automatic ACK reception.
    pub auto_ack_rx: bool,
    /// Enable enhanced ACK transmission.
    pub enhance_ack_tx: bool,
    /// Enable promiscuous mode.
    pub promiscuous: bool,
    /// Act as PAN coordinator.
    pub coordinator: bool,
    /// Receive packets when idle.
