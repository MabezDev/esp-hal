...
pub unsafe extern "C" fn ets_timer_disarm(timer: *mut c_void) {
    crate::radio::compat::timer_compat::compat_timer_disarm(timer.cast());
}

#[cfg(feature = "wifi")]
pub unsafe extern "C" fn ets_timer_done(timer: *mut c_void) {
    crate::radio::compat::timer_compat::compat_timer_done(timer.cast());
}
...
pub unsafe extern "C" fn ets_timer_arm(timer: *mut c_void, ms: u32, repeat: bool) {
    crate::radio::compat::timer_compat::compat_timer_arm(timer.cast(), ms, repeat);
}

#[cfg(feature = "wifi")]
pub unsafe extern "C" fn ets_timer_arm_us(timer: *mut c_void, us: u32, repeat: bool) {
    crate::radio::compat::timer_compat::compat_timer_arm_us(timer.cast(), us, repeat);
}
...
pub unsafe extern "C" fn queue_create(queue_len: u32, item_size: u32) -> *mut c_void {
    crate::radio::compat::queue::queue_create(queue_len as i32, item_size as i32).cast()
}
...
pub unsafe extern "C" fn queue_delete(queue: *mut c_void) {
    crate::radio::compat::queue::queue_delete(queue.cast());
}
...
pub unsafe extern "C" fn queue_send(
    ...
    crate::radio::compat::queue::queue_send_to_back(
        queue.cast(),
        item.cast_const(),
...
pub unsafe extern "C" fn queue_send_from_isr(
    ...
    crate::radio::compat::queue::queue_try_send_to_back_from_isr(
        queue.cast(),
        item.cast_const(),
...
pub unsafe extern "C" fn queue_send_to_front(
    ...
    crate::radio::compat::queue::queue_send_to_front(
        queue.cast(),
        item,
        blob_ticks_to_micros(block_time_tick),
    )
...
pub unsafe extern "C" fn queue_recv_from_isr(
    ...
    crate::radio::compat::queue::queue_try_receive_from_isr(
        queue.cast(),
        item,
        higher_priority_task_waken.cast(),
    )
...
pub unsafe extern "C" fn queue_msg_waiting(queue: *mut c_void) -> u32 {
    crate::radio::compat::queue::queue_messages_waiting(queue.cast())
}
