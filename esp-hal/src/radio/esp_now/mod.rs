...
use crate::{asynch::AtomicWaker, time::Duration};
use esp_sync::NonReentrantMutex;
use portable_atomic::{AtomicBool, AtomicU8, Ordering};

#[cfg(feature = "csi")]
use super::wifi::csi::CsiConfig;
use super::sys::include::*;
use super::wifi::{RxControlInfo, WifiError};
...
impl EspNowManager<'_> {
    ...
    pub fn set_csi(
        &mut self,
        mut csi: CsiConfig,
        cb: impl FnMut(super::wifi::csi::WifiCsiInfo<'_>) + Send,
    ) -> Result<(), WifiError> {
        csi.apply_config()?;
