...
//!
//! ## Config Options
//! See the esp-hal crate documentation for configuration options.
...
impl PhyState {
    ...
    fn calibrate(&mut self) {
        ...
        let init_data = &init_data::PHY_INIT_DATA_DEFAULT;
        unsafe {
...
macro_rules! impl_phy_controller {
    ($feature_gate:ident, $peripheral:tt) => {
        #[cfg($feature_gate)]
        impl private::Sealed for crate::peripherals::$peripheral<'_> {}

        #[cfg($feature_gate)]
        impl<'d> PhyController<'d> for crate::peripherals::$peripheral<'d> {}
    };
}
...
#[cfg(esp32)]
impl MacTimeExt for crate::peripherals::WIFI<'_> {}
