...
macro_rules! unwrap {
    ($arg:expr) => {
        match $crate::radio::phy::phy_fmt::Try::into_result($arg) {
            ::core::result::Result::Ok(t) => t,
            ::core::result::Result::Err(e) => { $crate::radio::phy::phy_fmt::__unwrap_failed(::core::stringify!($arg), e) }
        }
    };
    ($arg:expr, $msg:expr) => {
        match $crate::radio::phy::phy_fmt::Try::into_result($arg) {
            ::core::result::Result::Ok(t) => t,
            ::core::result::Result::Err(e) => { $crate::radio::phy::phy_fmt::__unwrap_failed_with_message(::core::stringify!($arg), e, $msg) }
        }
    };
    ($arg:expr, $($msg:expr),+ $(,)? ) => {
        match $crate::radio::phy::phy_fmt::Try::into_result($arg) {
            ::core::result::Result::Ok(t) => t,
            ::core::result::Result::Err(e) => { $crate::radio::phy::phy_fmt::__unwrap_failed_with_message(::core::stringify!($arg), e, ::core::format_args!($($msg,)*)) }
        }
    }
}
