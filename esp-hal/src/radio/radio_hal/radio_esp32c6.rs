use crate::peripherals::{INTERRUPT_CORE0, Interrupt};
...
pub(crate) fn shutdown_radio_isr() {
    #[cfg(feature = "ble")]
    {
        interrupt::disable(crate::system::Cpu::ProCpu, Interrupt::LP_TIMER);
        interrupt::disable(crate::system::Cpu::ProCpu, Interrupt::BT_MAC);
    }
}
...
extern "C" fn LP_TIMER() {
    unsafe {
        ...
        let (fnc, arg) = super::super::ble::npl::ble_os_adapter_chip_specific::ISR_INTERRUPT_7;
...
extern "C" fn BT_MAC() {
    unsafe {
        ...
        let (fnc, arg) = super::super::ble::npl::ble_os_adapter_chip_specific::ISR_INTERRUPT_4;
