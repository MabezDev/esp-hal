...
pub(crate) fn shutdown_radio_isr() {
    #[cfg(feature = "ble")]
    {
        interrupt::disable(crate::system::Cpu::ProCpu, Interrupt::LP_BLE_TIMER);
...
extern "C" fn LP_BLE_TIMER() {
    unsafe {
        ...
        let (fnc, arg) = super::super::ble::npl::ble_os_adapter_chip_specific::ISR_INTERRUPT_3;
...
extern "C" fn BT_MAC() {
    unsafe {
        ...
        let (fnc, arg) = super::super::ble::npl::ble_os_adapter_chip_specific::ISR_INTERRUPT_15;
