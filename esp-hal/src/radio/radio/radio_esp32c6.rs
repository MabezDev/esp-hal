...
use crate::{hal::interrupt, radio::sys};
...
extern "C" fn WIFI_MAC() {
    unsafe {
        let (fnc, arg): (*mut sys::c_types::c_void, *mut sys::c_types::c_void) =
            crate::radio::wifi::os_adapter::ISR_INTERRUPT_1;
...
extern "C" fn LP_TIMER() {
    unsafe {
        ...
        let (fnc, arg) = crate::radio::ble::npl::ble_os_adapter_chip_specific::ISR_INTERRUPT_7;
...
extern "C" fn BT_MAC() {
    unsafe {
        ...
        let (fnc, arg) = crate::radio::ble::npl::ble_os_adapter_chip_specific::ISR_INTERRUPT_4;
