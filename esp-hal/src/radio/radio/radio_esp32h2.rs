...
extern "C" fn LP_BLE_TIMER() {
    unsafe {
        ...
        let (fnc, arg) = crate::radio::ble::npl::ble_os_adapter_chip_specific::ISR_INTERRUPT_3;
...
extern "C" fn BT_MAC() {
    unsafe {
        ...
        let (fnc, arg) = crate::radio::ble::npl::ble_os_adapter_chip_specific::ISR_INTERRUPT_15;
