...
extern "C" fn coex_schm_register_btdm_callback(_callback: *const ()) -> i32 {
    ...
    unsafe {
        ...
        coex_schm_register_callback(1, _callback as *mut crate::radio::sys::c_types::c_void)
    }
...
extern "C" fn coex_schm_interval_get() -> i32 {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_schm_interval_get() as i32
    }
...
extern "C" fn coex_schm_curr_period_get() -> u8 {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_schm_curr_period_get()
    }
...
extern "C" fn coex_schm_curr_phase_get() -> *const () {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_schm_curr_phase_get().cast()
    }
...
impl Config {
    pub(crate) fn validate(&self) -> Result<(), InvalidConfigError> {
        crate::radio::ble::validate_range!(self, max_connections, 1, 10);
        ...
        crate::radio::ble::validate_range!(self, cca_threshold, 20, 100);
