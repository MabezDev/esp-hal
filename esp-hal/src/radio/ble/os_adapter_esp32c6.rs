...
use crate::radio::sys::include::esp_bt_controller_config_t;
...
impl Config {
    pub(crate) fn validate(&self) -> Result<(), InvalidConfigError> {
        crate::radio::ble::validate_range!(self, max_connections, 1, 70);
        crate::radio::ble::validate_range!(self, ll_sync_cnt, 0, 3);
        crate::radio::ble::validate_range!(self, ll_sync_list_cnt, 1, 5);
        crate::radio::ble::validate_range!(self, ll_rsp_dup_list_count, 1, 100);
        crate::radio::ble::validate_range!(self, ll_adv_dup_list_count, 1, 100);
        crate::radio::ble::validate_range!(self, whitelist_size, 1, 31);
        crate::radio::ble::validate_range!(self, multi_adv_instances, 0, 4);
        crate::radio::ble::validate_range!(self, ext_adv_max_size, 0, 1650);
        crate::radio::ble::validate_range!(self, scan_backoff_max, 1, 256);
