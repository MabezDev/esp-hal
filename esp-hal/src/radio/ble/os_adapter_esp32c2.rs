...
impl Config {
    pub(crate) fn validate(&self) -> Result<(), InvalidConfigError> {
        super::validate_range!(self, max_connections, 1, 2);
        super::validate_range!(self, ll_sync_cnt, 0, 3);
        super::validate_range!(self, ll_sync_list_cnt, 1, 5);
        super::validate_range!(self, ll_rsp_dup_list_count, 1, 100);
        super::validate_range!(self, ll_adv_dup_list_count, 1, 100);
        super::validate_range!(self, whitelist_size, 1, 31);
        super::validate_range!(self, multi_adv_instances, 0, 4);
        super::validate_range!(self, ext_adv_max_size, 0, 1650);
        super::validate_range!(self, scan_backoff_max, 1, 256);
        super::validate_range!(self, cca_threshold, 20, 100);
        Ok(())
    }
}
