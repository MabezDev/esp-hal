...
use crate::radio::compat::common::str_from_c;
use crate::ram;
use crate::radio::sys::{c_types::*, include::*};
...
extern "C" fn notify_host_recv(data: *mut u8, len: u16) -> i32 {
    ...
    crate::radio::ble::controller::hci_read_data_available();
...
unsafe extern "C" fn task_yield() {
    crate::radio::preempt::yield_task();
}
...
unsafe extern "C" fn task_yield_from_isr() {
    ...
    crate::radio::preempt::yield_task_from_isr();
}
...
unsafe extern "C" fn task_create(
    func: *mut crate::radio::sys::c_types::c_void,
    name_ptr: *const c_char,
    stack_depth: u32,
    param: *mut crate::radio::sys::c_types::c_void,
    prio: u32,
    handle: *mut crate::radio::sys::c_types::c_void,
    core_id: u32,
) -> i32 {
    ...
    unsafe {
        ...
        let task = crate::radio::preempt::task_create(
            name,
            task_func,
            param,
            prio,
...
unsafe extern "C" fn task_delete(task: *mut ()) {
    ...
    unsafe {
        crate::radio::preempt::schedule_task_deletion(NonNull::new(task));
    }
}

#[ram]
unsafe extern "C" fn is_in_isr() -> i32 {
    crate::radio::is_interrupts_disabled() as i32
}
...
unsafe extern "C" fn rand() -> i32 {
    trace!("rand");
    unsafe { crate::radio::common_adapter::random() as i32 }
}
...
unsafe extern "C" fn coex_schm_status_bit_set(_typ: i32, status: i32) {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_schm_status_bit_set(_typ as u32, status as u32)
    };
}
...
unsafe extern "C" fn coex_schm_status_bit_clear(_typ: i32, status: i32) {
    ...
    #[cfg(coex)]
    unsafe {
        crate::radio::sys::include::coex_schm_status_bit_clear(_typ as u32, status as u32)
    };
}

#[ram]
unsafe extern "C" fn read_efuse_mac(mac: *const ()) -> i32 {
    unsafe { crate::radio::common_adapter::read_mac(mac as *mut _, 2) }
}
...
pub(crate) fn ble_init(config: &Config) -> PhyInitGuard<'static> {
    ...
    unsafe {
        ...
        #[cfg(coex)]
        {
            let res = crate::radio::wifi::coex_init();
        ...
        #[cfg(coex)]
        crate::radio::sys::include::coex_enable();

        phy_init_guard = crate::peripherals::BT::steal().enable_phy();
