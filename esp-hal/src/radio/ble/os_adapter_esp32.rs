...
use super::*;
use super::super::InvalidConfigError;
use crate::radio::common_adapter::*;
use crate::{interrupt, peripherals::Interrupt};
...
pub(super) static G_OSI_FUNCS: osi_funcs_s = osi_funcs_s {
    ...
    malloc_internal: Some(crate::radio::ble::malloc_internal),
    free: Some(crate::radio::ble::free),
    read_efuse_mac: Some(read_efuse_mac),
    srand: Some(crate::radio::ble::btdm::srand),
    rand: Some(crate::radio::ble::btdm::rand),
...
extern "C" fn coex_version_get_wrapper(major: *mut u32, minor: *mut u32, patch: *mut u32) -> i32 {
    unsafe {
        let mut version = crate::radio::sys::include::coex_version_t {
            major: 0,
            minor: 0,
            patch: 0,
        };
...
impl Config {
    pub(crate) fn validate(&self) -> Result<(), InvalidConfigError> {
        crate::radio::ble::validate_range!(self, max_connections, 1, 9);
        crate::radio::ble::validate_range!(self, scan_duplicate_list_count, 10, 1000);
        crate::radio::ble::validate_range!(self, scan_duplicate_refresh_period, 0, 1000);
        crate::radio::ble::validate_range!(self, enc_key_sz_min, 7, 16);
...
pub(crate) unsafe extern "C" fn coex_schm_curr_phase_get() -> *const () {
    ...
    #[cfg(coex)]
    return unsafe { crate::radio::sys::include::coex_schm_curr_phase_get() } as *const ();
...
pub(crate) unsafe extern "C" fn ints_on(mask: u32) {
    ...
    unsafe {
        crate::xtensa_lx::interrupt::enable_mask(mask);
    }
}
