...
use super::super::phy::PhyInitGuard;

use super::super::{
    InitializationError,
    RadioRefGuard,
};
use super::{Config, InvalidConfigError, have_hci_read_data, read_hci, read_next, send_hci};
...
pub struct BleConnector<'d> {
    ...
    _device: crate::peripherals::BT<'d>,
...
impl<'d> BleConnector<'d> {
    ...
    pub fn new(
        ...
        Ok(Self {
            _phy_init_guard: super::ble_init(&config),
            _device: device,
            _guard,
        })
    }
